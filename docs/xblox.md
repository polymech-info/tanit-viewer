...
- `encoder` (<span data-cli="meta"><span data-cli="type">enum</span>, <span data-cli="default">default <span data-cli="value">&quot;auto&quot;</span></span>, <span data-cli="tag" data-variant="enum">one of</span> <span data-cli="choices" data-variant="enum"><span data-cli="choice">auto</span> <span data-cli="choice">nvenc</span> <span data-cli="choice">mediaFoundation</span></span></span>) - Fast Windows capture encoder. auto and nvenc try the optional NVIDIA plugin, then Media Foundation when pm-video-nvenc.dll is missing or will not load. mediaFoundation uses the Windows encoder. A missing NVENC plugin does not fail the block.

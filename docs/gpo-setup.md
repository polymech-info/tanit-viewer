...
Available tool names as of this build (53 tools):
  ?: app_command
  ...
  Utility: ask_user, audio_transcribe, create_command, file_delete, file_str_replace, info_lookup, run, run_sequence, speak, write_file
